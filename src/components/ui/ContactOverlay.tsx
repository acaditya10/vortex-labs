...
export function ContactOverlay() {
  const { open, expanded, hide, expand, collapse } = useContact();
  ...
  useEffect(() => {
    ...
    const onKey = (e: KeyboardEvent) => {
      if (e.key === "Escape") expanded ? collapse() : hide();
    };
  ...
  return (
    ...
    >
      ...
      {/* Left panel — Cal.com */}
      <div className={`${styles.left} ${expanded ? styles.leftHidden : ""}`}>
        <div className={styles.leftContent}>
          <p className={styles.panelLabel}>BOOK A DISCOVERY CALL</p>
          <p className={styles.panelDesc}>
            Pick a time that works. 30 minutes to understand your goals and see if we&apos;re the right fit.
          </p>
          <button className={styles.expandBtn} onClick={expand}>
      ...
      {/* Right panel — Form */}
      <div className={`${styles.right} ${expanded ? styles.rightHidden : ""}`}>
          ...
          {submitted ? (
            ...
            <form ref={formRef} onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className={styles.field}>
                ...
                <textarea id="ov-message" name="message" rows={4} placeholder="Tell us about your project..." className={styles.input} />
              </div>
